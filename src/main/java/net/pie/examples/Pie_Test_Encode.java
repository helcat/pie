...
public class Pie_Test_Encode {
    ...
    private String temp_Encoded_Image = ".jpg";
    ...
    public Pie_Test_Encode(String arg) {
        ...
        Pie_Config encoding_config = null;
        //try {
            encoding_config = new Pie_Config(
                    ...
                    //new Pie_Encode_Source(new URL("https://corecreate.s3.eu-west-2.amazonaws.com/corecreateFiles.zip")),
                    ...
                    new Pie_Encoded_Destination(new File(Pie_Utils.getDesktopPath() + File.separator + "test")),
