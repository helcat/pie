...
/* ********  E N C O D I N G   M E T H O D S  ******** */
    ...
    public static byte[] encodeBytesToBytes( byte[] source ) {
        byte[] encoded = null;
        try {
            encoded = encodeBytesToBytes( source, 0, source.length, Pie_Base64.NO_OPTIONS );
        } catch( java.io.IOException ex ) {
    ...
    public static byte[] encodeBytesToBytes( byte[] source, int off, int len, int options ) throws java.io.IOException {
        ...
        if( (options & GZIP) != 0 ) {
            ...
            Pie_Base64.OutputStream            b64os = null;
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    throws java.io.IOException {
        byte[] decoded = null;
//        try {
            decoded = decode( source, 0, source.length, Pie_Base64.NO_OPTIONS );
//        } catch( java.io.IOException ex ) {
//            assert false : "IOExceptions only come from GZipping, which is turned off: " + ex.getMessage();
//        }
        return decoded;
    ...
    throws java.io.IOException {
        ...
        Pie_Base64.InputStream bis = null;
        try
        {
            ...
            // Open a stream
            bis = new Pie_Base64.InputStream(
                      new java.io.BufferedInputStream(
                      new java.io.FileInputStream( file ) ), Pie_Base64.DECODE );
    ...
    throws java.io.IOException {
        ...
        try
        {
            ...
            bis = new Pie_Base64.InputStream(
                      new java.io.BufferedInputStream(
                      new java.io.FileInputStream( file ) ), Pie_Base64.ENCODE );
            ...
            // Save in a variable to return
            encodedData = new String( buffer, 0, length, Pie_Base64.PREFERRED_ENCODING );
    ...
    /**
     * A {@link Pie_Base64.InputStream} will read data from another
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link Pie_Base64.InputStream} in
         ...
         * @param options Specified options
         * @see Pie_Base64#ENCODE
         * @see Pie_Base64#DECODE
         * @see Pie_Base64#DO_BREAK_LINES
         * @since 2.0
         */
    ...
    /**
     * A {@link Pie_Base64.OutputStream} will write data to another
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link Pie_Base64.OutputStream} in
         * either ENCODE or DECODE mode.
         * <p>
         * Valid options:<pre>
         *   ENCODE or DECODE: Encode or Decode as data is read.
            ...
            // Else, Decoding
                ...
                if( decodabet[ theByte & 0x7f ] > WHITE_SPACE_ENC ) {
                    ...
                    if( position >= bufferLength ) { // Enough to output.
                        ...
                        int len = Pie_Base64.decode4to3( buffer, 0, b4, 0, options );
                        out.write( b4, 0, len );
                        position = 0;
                    }   // end if: enough to output
                }   // end if: meaningful Pie_Base64 character
                else if( decodabet[ theByte & 0x7f ] != WHITE_SPACE_ENC ) {
                    throw new java.io.IOException( "Invalid character in Pie_Base64 data." );
