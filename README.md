...
To create a certificate use this standalone command.
        ...
        Pie_Encryption encryption = new Pie_Encryption();
        File certificate = encryption.create_Certificate_File(new Pie_Config(Level.INFO), Pie_Utils.getDesktop(), "pie_certificate");

First create a "Pie_Encryption" object. Next create the certificate using the "create_Certificate_File" method.
...
Generates a certificate of bewteen 100 - 600 random byte charactors. Bytes are between 1 - 255.
